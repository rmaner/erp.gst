...
Begin VB.Form frmPrintMemo 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Top             =   135
         Width           =   2100
         Begin VB.CommandButton cmdChangePaperSize 
            Height          =   300
            Index           =   1
            Left            =   510
            Picture         =   "frmPrintMemo.frx":4E0E
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   0
            Width           =   300
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.ComboBox cmbPaperSizes 
            ...
            ItemData        =   "frmPrintMemo.frx":5246
            Left            =   0
            List            =   "frmPrintMemo.frx":5248
            TabIndex        =   9
            Text            =   "cmbPaperSizes"
            Top             =   330
            Width           =   1590
         ...
         Begin VB.ComboBox cmbMemoFormat 
            ...
            Height          =   315
            IntegralHeight  =   0   'False
            ItemData        =   "frmPrintMemo.frx":524A
            Left            =   0
            List            =   "frmPrintMemo.frx":524C
            TabIndex        =   8
            Text            =   "cmbMemoFormat"
            Top             =   0
            Width           =   1590
      ...
      Begin VSPrinter8LibCtl.VSPrinter vp 
         ...
         PalettePicture  =   "frmPrintMemo.frx":524E
         AbortWindow     =   -1  'True
         AbortWindowPos  =   0
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton cmdMail 
         Height          =   330
         Left            =   7485
         Picture         =   "frmPrintMemo.frx":28004
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   15
         Width           =   465
...
Public Sub RenderMemo(ByVal MemoFormatOption As Integer)
    ...
    If CN(0).recs.RecordCount = 1 Then
        ...
        vp.StartDoc
            vp.Copies = 1
            SetFont "[Render_Section_A]": Render_Section_A MemoFormatOption
            SetFont "[Render_Section_B]": Render_Section_B MemoFormatOption
            SetFont "[Render_Section_C]": Render_Section_C MemoFormatOption
            SetFont "[Render_Section_D]": Render_Section_D MemoFormatOption
            SetFont "[Render_Section_E]": Render_Section_E MemoFormatOption
            SetFlxFont "[Render_Section_F]": Render_Section_F MemoFormatOption
            SetFont "[Render_Section_G]": Render_Section_G MemoFormatOption
            SetFont "[Render_Section_H]": Render_Section_H MemoFormatOption
            SetFont "[Render_Section_I]": Render_Section_I MemoFormatOption
            SetFont "[Render_Section_J]": Render_Section_J MemoFormatOption
            SetFont "[Render_Section_K]": Render_Section_K MemoFormatOption
            Render_Section_L MemoFormatOption
        vp.EndDoc
        SetFont "[Render_Section_Z]": Render_Section_Z MemoFormatOption   'OVERLAY
    End If
End Sub

Public Sub Render_Section_A(ByVal MemoFormatOption As Integer)
    vp.CurrentY = 200
    With vp
...
Public Sub Render_Section_B(ByVal MemoFormatOption As Integer)
...
Public Sub Render_Section_C(ByVal MemoFormatOption As Integer)
    Select Case MemoFormatOption
        Case 2:
        Case 4, 5:
            With vp
...
Public Sub Render_Section_D(ByVal MemoFormatOption As Integer)
    With vp
    Select Case MemoFormatOption
        Case 1:
...
Public Sub Render_Section_E(ByVal MemoFormatOption As Integer)
    Select Case MemoFormatOption
        Case 10:
            With vp
                .CurrentY = .CurrentY + 50
...
Public Sub Render_Section_F(ByVal MemoFormatOption As Integer)
...
Public Sub Render_Section_G(ByVal MemoFormatOption As Integer)
    With vp
        If MemoFormatOption <> 1 And MemoFormatOption <> 4 Then
            .CurrentY = .CurrentY + 50
            .StartTable
                .TableBorder = tbBottom: .TableCell(tcCols) = 8: .TableCell(tcRows) = 2
...
Public Sub Render_Section_H(ByVal MemoFormatOption As Integer)
    With vp
        If MemoFormatOption <> 1 And MemoFormatOption <> 4 Then
            .FontBold = True
            .StartTable
...
Public Sub Render_Section_I(ByVal MemoFormatOption As Integer)
    With vp
    .FontBold = True
    Select Case MemoFormatOption
        Case 0, 2, 3, 4:
            .StartTable
                ...
                .TableBorder = tbBottom: .TableCell(tcCols) = 1: .TableCell(tcRows) = 1
                .TableCell(tcColWidth, , 1) = "7.70in": .TableCell(tcColAlign, , 1) = taLeftMiddle
                '.TableCell(tcText, 1, 1) = "Your ledger balance at " & Now & " is Rs." & Format(Val(WhatIsLedgerBalance(CN(0).recs!ID)), "#,#00.00(Dr); #,#00.00(Cr)")
...
Public Sub Render_Section_J(ByVal MemoFormatOption As Integer)
    With vp
        '
    End With
End Sub

Public Sub Render_Section_K(ByVal MemoFormatOption As Integer)
    On Error Resume Next
...
Public Sub Render_Section_L(ByVal MemoFormatOption As Integer)
    On Error Resume Next
    If vp.CurrentY < vp.PageHeight / 2 Then
        vp.CurrentY = vp.PageHeight / 2
        vp.DrawLine 0, (vp.PageHeight / 2) - 50, 200, (vp.PageHeight / 2) - 50
        vp.DrawLine vp.PageWidth - 200, (vp.PageHeight / 2) - 50, vp.PageWidth, (vp.PageHeight / 2) - 50
        'vp.DrawLine 0, vp.PageHeight, vp.PageWidth, vp.PageHeight / 2
    End If
End Sub

Public Sub Render_Section_Z(ByVal MemoFormatOption As Integer)
    Select Case MemoFormatOption
        Case 2:
            With vp
                ...
                For i = 1 To vp.PageCount
                    ...
                    vp.CurrentY = 250
                    If i = 1 Then
                        vp.Text = "{ " & "Page " & i & " of " & vp.PageCount & " \b [" & Ref & "] }"
                    Else
                        vp.Text = "{ " & "Page " & i & " of " & vp.PageCount & " \b " & MemoNo & " " & Format(CN(0).recs!DBDate, "dd-MM-yy") & "(" & CN(0).recs!ID & ")" & Space(50) & " [" & Ref & "] }"
                    End If
                    vp.EndOverlay
                Next
            End With
        Case Else:
            With vp
                ...
                For i = 1 To vp.PageCount
                    ...
                    vp.CurrentY = 250
                    If i = 1 Then
                        vp.Text = "{ " & "Page " & i & " of " & vp.PageCount & " \par\b [" & Ref & "] }"
                    Else
                        vp.Text = "{ " & "Page " & i & " of " & vp.PageCount & " \par\b " & MemoNo & " " & Format(CN(0).recs!DBDate, "dd-MM-yy") & "(" & CN(0).recs!ID & ")" & Space(50) & " [" & Ref & "] }"
                    End If
                    vp.EndOverlay
                Next
            End With
...
Private Sub cmdChangePaperSize_MouseDown(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Index = 0 Then 'Change Width
        If Shift = vbCtrlMask Then
            vp.MarginLeft = vp.MarginLeft + 50
            vp.MarginRight = vp.MarginRight + 50
        Else
            vp.MarginLeft = vp.MarginLeft - 50
            vp.MarginRight = vp.MarginRight - 50
        End If
    End If
    If Index = 1 Then 'Change Height
        If Shift = vbCtrlMask Then
            vp.MarginTop = vp.MarginTop + 50
            vp.MarginBottom = vp.MarginBottom + 50
        Else
            vp.MarginTop = vp.MarginTop - 50
            vp.MarginBottom = vp.MarginBottom - 50
        End If
