...
Begin VB.Form frmRCT 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmRCT.frx":114DA
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame2"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Print..."
      TabPicture(1)   =   "frmRCT.frx":114F6
   ...
   End
End
Attribute VB_Name = "frmRCT"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Const MemoFormat = "\R\T0"
Private Const Table = "RCT"
Private Const NewProc = "ADDNEW_RCT"
Private Const SaveProc = "UPDATE_RCT"
