...
Begin VB.Form frmPurchase 
   ...
   Begin TabDlg.SSTab sstOne 
      ...
      TabPicture(0)   =   "frmPurchase.frx":5151
      ...
      Begin VB.Frame fraCustomer 
         ...
         Begin VB.PictureBox pboxB 
            ...
            Begin VB.CommandButton cmdSelectID 
               DownPicture     =   "frmPurchase.frx":51A5
               Height          =   285
               Left            =   975
               Picture         =   "frmPurchase.frx":54E8
               Style           =   1  'Graphical
               TabIndex        =   80
               Top             =   0
               UseMaskColor    =   -1  'True
...
Private Const MyCAPTION = "Purchase "
Private Const Stk = False

Private Const HiddenCols = "[frmSale-flxItems-HiddenCols]"
Private Const Main = "PMAIN"
Private Const Support = "PURCHASE"
Private Const MainAddNew = "ADDNEW_PMain"
Private Const MainSelectView = "appview_PMain_Select_View"
