      ...
      Begin VB.Frame fraCustomer 
         ...
         Begin VB.PictureBox pboxB 
            ...
            Begin VB.CommandButton cmdSelectID 
               DownPicture     =   "frmSale.frx":51A5
               Height          =   285
               Left            =   975
               Picture         =   "frmSale.frx":54E8
               Style           =   1  'Graphical
               TabIndex        =   7
               Top             =   0
               UseMaskColor    =   -1  'True
...
Private Const MyCAPTION = "Sale "
Private Const Stk = True

Private Const HiddenCols = "[frmSale-flxItems-HiddenCols]"
Private Const Main = "SMAIN"
Private Const Support = "SALE"
Private Const MainAddNew = "ADDNEW_SMain"
Private Const MainSelectView = "appview_SMain_Select_View"
