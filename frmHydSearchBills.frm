...
Begin VB.Form frmHydSearchBills 
   ...
   Begin VB.PictureBox PicA 
      ...
      Begin VB.ComboBox cmbFields 
         ...
         ItemData        =   "frmHydSearchBills.frx":0000
         Left            =   5850
         List            =   "frmHydSearchBills.frx":0002
         Sorted          =   -1  'True
         TabIndex        =   3
         Text            =   "cmbPublisher"
         Top             =   30
      ...
      Begin VB.ComboBox cmbTables 
         ...
         Height          =   315
         IntegralHeight  =   0   'False
         ItemData        =   "frmHydSearchBills.frx":0004
         Left            =   885
         List            =   "frmHydSearchBills.frx":0006
         Sorted          =   -1  'True
         TabIndex        =   1
         Text            =   "cmbPublisher"
         Top             =   15
...
Private Sub cmdSaveGrid_Click()
    ...
    If MsgBox("Do you wish to save the grid?", vbYesNo + vbQuestion) = vbYes Then
        mdiOne.CDlg.FileName = "SearchBills-" & Format(Now, "DD-MMM-YY HHMM")
        mdiOne.CDlg.Filter = CompanyName & " Excel Report |*.xls"
        mdiOne.CDlg.ShowSave
        If mdiOne.CDlg.CancelError = False Then flxItem.SaveGrid mdiOne.CDlg.FileName, flexFileExcel
    End If
End Sub

Private Sub Form_Load()
    mdiOne.SetFormFont Me
    chkExactLike.Value = 1
    cmbTables.Clear
    opt = 0
    cmbTables.AddItem "PUBIG"
    cmbTables.AddItem "PRBIG"
    cmbTables.AddItem "SABIG"
    cmbTables.AddItem "SRBIG"
    cmbTables.AddItem "TIBIG"
    cmbTables.AddItem "TOBIG"
    opt = 1
End Sub
...
Private Sub LoadFields()
    On Error Resume Next
    If opt = 1 Then
        CN(0).dbOpen "SELECT TOP 1 * FROM " & cmbTables.Text, 1
        cmbFields.Clear
