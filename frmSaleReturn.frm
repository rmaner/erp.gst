...
Begin VB.Form frmSaleReturn 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.PictureBox pboxA 
         ...
         Begin VB.CommandButton cmdSelectDBRef 
            Height          =   345
            Left            =   1425
            Picture         =   "frmSaleReturn.frx":4E0E
            Style           =   1  'Graphical
            TabIndex        =   12
            Top             =   1380
            Width           =   1425
   ...
   Begin TabDlg.SSTab sstOne 
      ...
      TabPicture(0)   =   "frmSaleReturn.frx":5151
      ...
      TabPicture(1)   =   "frmSaleReturn.frx":516D
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "fraTransporter"
      Tab(1).Control(1)=   "fraKarter"
      Tab(1).ControlCount=   2
      TabCaption(2)   =   "Good Recv && SubDistributor"
      TabPicture(2)   =   "frmSaleReturn.frx":5189
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "fraSubDist"
      Tab(2).Control(1)=   "fraGoods"
      ...
      Begin VB.Frame fraCustomer 
         ...
         Begin VB.PictureBox pboxB 
            ...
            Begin VB.CommandButton cmdSelectID 
               DownPicture     =   "frmSaleReturn.frx":51A5
               Height          =   285
               Left            =   975
               Picture         =   "frmSaleReturn.frx":54E8
               Style           =   1  'Graphical
               TabIndex        =   80
               Top             =   0
               UseMaskColor    =   -1  'True
...
Private Const MyCAPTION = "SaleReturn "
Private Const Stk = False

Private Const HiddenCols = "[frmSale-flxItems-HiddenCols]"
Private Const Main = "SRETURNMAIN"
Private Const Support = "SALERETURN"
Private Const MainAddNew = "ADDNEW_SRETURNMain"
Private Const MainSelectView = "appview_SRETURNMain_Select_View"
Private Const PartyView = "appview_AllAccounts"
Private Const PartyInitial = "C%"
Private Const ItemSelectView = "appview_SelectItemSale"

Private Const MemoFormat = "\S\R0"
